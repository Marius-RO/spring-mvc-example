        ...
        <div class="d-flex justify-content-center">
            <div class="w-25 p-3">
                ...
                <div class="d-flex flex-column">
                    ...
                    <c:if test="${attributeErrorAddProduct}">
                        <div class="p-2">
                    ...
                    <c:if test="${attributeErrorImage}">
                        <div class="p-2">
                            <div class="alert alert-danger" role="alert">
                                Chosen file is not a valid image
                            </div>
                        </div>
                    </c:if>
                    <!-- END Custom messages -->
                    ...
                    <div class="p-2">
                        ...
                        <!--
                         ...
                         -->
                        <form:form action="${productControllerProcessAddProductLink}?${_csrf.parameterName}=${_csrf.token}" method="post" modelAttribute="productDto" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="idChooseImage">Add image</label>
                                <form:input type="file" path="imageMultipartFile" class="form-control" id="idChooseImage"/>
                            </div>

                            <div class="text-center">
                                <button type="submit" class="h-25 w-100 btn btn-primary">Add product</button>
                            </div>
